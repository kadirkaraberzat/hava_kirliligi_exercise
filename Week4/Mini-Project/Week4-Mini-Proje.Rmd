...
```{r}
# havaK <- read_excel("C:\\Users\\User3456\\Desktop\\Veri Detayları3_21_2024, 9_31_28 PM.xlsx")
# rapor <- head(havaK, 10)
# print(rapor)
...
```{r}
# time_column_index <- which(col_names == "Tarih")
# col_names[time_column_index] <- "Time"
# colnames(havaK) <- col_names
